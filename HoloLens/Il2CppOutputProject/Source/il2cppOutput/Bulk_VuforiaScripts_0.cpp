...
IL_002a:
	{
		...
		NullCheck(L_23);
		GUIStyle_set_fontSize_mA9F9F916A9BC3B81CFEE7460966FFD1E6B67F45F(L_23, (((int32_t)((int32_t)(int32_t)((float)((float)((float)il2cpp_codegen_multiply((float)(((float)((float)((int32_t)il2cpp_codegen_multiply((int32_t)((int32_t)18), (int32_t)L_24))))), (float)L_25))/(float)(160.0f)))))), /*hidden argument*/NULL);
		...
		NullCheck(L_38);
		GUIStyle_set_fontSize_mA9F9F916A9BC3B81CFEE7460966FFD1E6B67F45F(L_38, (((int32_t)((int32_t)(int32_t)((float)((float)((float)il2cpp_codegen_multiply((float)(((float)((float)((int32_t)il2cpp_codegen_multiply((int32_t)((int32_t)24), (int32_t)L_39))))), (float)L_40))/(float)(160.0f)))))), /*hidden argument*/NULL);
		...
		NullCheck(L_49);
		GUIStyle_set_fontSize_mA9F9F916A9BC3B81CFEE7460966FFD1E6B67F45F(L_49, (((int32_t)((int32_t)(int32_t)((float)((float)((float)il2cpp_codegen_multiply((float)(((float)((float)((int32_t)il2cpp_codegen_multiply((int32_t)((int32_t)28), (int32_t)L_50))))), (float)L_51))/(float)(160.0f)))))), /*hidden argument*/NULL);
		// }
		return;
	}
}
...
IL_0008:
	{
		...
		OpenSourceUnityCompiledFacade__ctor_mD1C7B1FF10B06A34B2AE88FE78D3F6A0B9941907(L_1, /*hidden argument*/NULL);
